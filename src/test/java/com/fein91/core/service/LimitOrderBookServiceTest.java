...
public class LimitOrderBookServiceTest {
    ...
    * */
    ...
    public void marketOrderTest1() throws Exception {
        ...
        limitOrderBookService.addAskLimitOrder(lobDecorator, buyer1, 200, buyer1AskPrice);
        double buyer2AskPrice = 28d;
        limitOrderBookService.addAskLimitOrder(lobDecorator, buyer2, 150, buyer2AskPrice);
        ...
        Trade trade2 = findTradeByBuyerAndSeller(lobDecorator.lob.getTape(), supplier.getId().intValue(), buyer2.getId().intValue());
        Assert.assertNotNull(trade2);
        Assert.assertEquals(trade2.getPrice(), buyer2AskPrice, 0d);
        Assert.assertEquals(trade2.getQty(), 150);
        Trade trade3 = findTradeByBuyerAndSeller(lobDecorator.lob.getTape(), supplier.getId().intValue(), buyer3.getId().intValue());
    ...
    public void marketOrderTest2() throws Exception {
        ...
        limitOrderBookService.addBidLimitOrder(lobDecorator, supplier1, 200, supplier1AskPrice);
        double supplier2AskPrice = 28d;
        limitOrderBookService.addBidLimitOrder(lobDecorator, supplier2, 150, supplier2AskPrice);
        double supplier3AskPrice = 29d;
        limitOrderBookService.addBidLimitOrder(lobDecorator, supplier3, 100, supplier3AskPrice);
        ...
        Trade trade2 = findTradeByBuyerAndSeller(lobDecorator.lob.getTape(), supplier2.getId().intValue(), buyer.getId().intValue());
        Assert.assertNotNull(trade2);
        Assert.assertEquals(trade2.getPrice(), supplier2AskPrice, 0d);
        Assert.assertEquals(trade2.getQty(), 150);

        Trade trade3 = findTradeByBuyerAndSeller(lobDecorator.lob.getTape(), supplier3.getId().intValue(), buyer.getId().intValue());
        Assert.assertNotNull(trade3);
        Assert.assertEquals(trade3.getPrice(), supplier3AskPrice, 0d);
        Assert.assertEquals(trade3.getQty(), 50);

        Trade trade4 = findTradeByBuyerAndSeller(lobDecorator.lob.getTape(), supplier4.getId().intValue(), buyer.getId().intValue());
    ...
    public void marketOrderTest3() throws Exception {
        ...
        double supplier1AskPrice = 27d;
        limitOrderBookService.addBidLimitOrder(lobDecorator, supplier1, 300, supplier1AskPrice);
    ...
    * */
    ...
    public void marketOrderTest4() throws Exception {
        ...
        limitOrderBookService.addAskLimitOrder(lobDecorator, buyer1, 600, buyer1AskPrice);
        double buyer2AskPrice = 30d;
        limitOrderBookService.addAskLimitOrder(lobDecorator, buyer2, 100, buyer2AskPrice);
    ...
    * */
    ...
    public void marketOrderTest5() throws Exception {
        ...
        limitOrderBookService.addBidLimitOrder(lobDecorator, supplier1, 550, supplier1AskPrice);
