...
(function (U, W, v) {
    ...
    function p(a, b, d) {
        var c, e;
        if (a)if (E(a))for (c in a)"prototype" == c || "length" == c || "name" == c || a.hasOwnProperty && !a.hasOwnProperty(c) || b.call(d, a[c], c, a); else if (K(a) || za(a)) {
    ...
    function he() {
        ...
        if (!Ac) {
            var b = ob();
            (qa = r(b) ? U.jQuery : b ? U[b] : v) && qa.fn.on ? (z = qa, M(qa.fn, {
                scope: Qa.scope,
        ...
        return b(a, "module", function () {
            ...
            return function (f, g, h) {
                ...
                return b(a, f, function () {
                    ...
                    var c = [], e = [], G = [], A = a("$injector", "invoke", "push", e), u = {
                        _invokeQueue: c,
                        _configBlocks: e,
                        _runBlocks: G,
                        requires: g,
    ...
    function je(a) {
        ...
        Sb("ng", ["ngLocale"], ["$provide", function (a) {
            ...
            a.provider("$compile", Cc).directive({
                ...
                ngValue: Se,
                ngModelOptions: Te
            }).directive({ngInclude: Ue}).directive(sb).directive(Ic);
            a.provider({
                $anchorScroll: Ve,
                $animate: We,
                $animateCss: Xe,
            ...
            "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, l, w, t, N, D, T, B) {
                ...
                function X(a, b, c, d, e, f) {
                    function g(a, c, d, e) {
                        ...
                        if (q)for (t = Array(c.length),
                                       l = 0; l < h.length; l += 3)f = h[l], t[f] = c[f]; else t = c;
                        l = 0;
                ...
                function $(a, b, d, e, f, g, h, m, l) {
                    ...
                    for (var P = -Number.MAX_VALUE, A = l.newScopeDirective, u = l.controllerDirectives, C = l.newIsolateScopeDirective,
                        ...
                        if (r.templateUrl)p = !0, Va("template", X, r, $), X = r, r.replace && (g = r), w = Vf(a.splice(F, a.length - F), $, d, f, N && Ha, h, m, {
                            controllerDirectives: u,
                            newScopeDirective: A !== r && A,
                ...
                function Vf(a, b, c, d, e, f, g, k) {
                    var h = [], m, n, B = b[0], t = a.shift(), J = Ob(t, {
                        templateUrl: null,
                        transclude: null,
                        replace: null,
                        $$originalDirective: t
                    }), S = E(t.templateUrl) ? t.templateUrl(b, c) : t.templateUrl, w = t.templateNamespace;
                    b.empty();
                    l(S).then(function (l) {
                        var q, A;
                        l = ia(l);
                ...
                fa.prototype = {
                    $normalize: va, $addClass: function (a) {
                        ...
                        f =
                            pa(this.$$element);
                        if ("a" === f && "href" === a || "img" === f && "src" === a)this[a] = b = B(b, "src" === a); else if ("img" === f && "srcset" === a) {
    ...
    function kf() {
        var a = this.defaults = {
            ...
            headers: {common: {Accept: "application/json, text/plain, */*"}, post: ha(ac), put: ha(ac), patch: ha(ac)},
            ...
            function h(f,
                ...
                function q(a) {
                    try {
                        ...
                        var d;
                        if (n && !x(a))d = a; else if (null == a)d = ""; else {
                            switch (typeof a) {
                                case "string":
                                    break;
                                case "number":
                ...
                n = !!n;
                for (var w, t, p = 0, D = [], T = [], B = f.length, C = [], J = []; p < B;)if (-1 != (w = f.indexOf(a, p)) && -1 != (t = f.indexOf(b, w + k)))p !== w && C.push(g(f.substring(p, w))), p = f.substring(w + k, t), D.push(p), T.push(d(p, q)), p = t + m, J.push(C.length), C.push(""); else {
    ...
    var K = Array.isArray, Zd = /^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array\]$/, V = function (a) {
        ...
        return ob.name_ = e
    }, be = /:/g, Pa = ["ng-", "data-ng-", "ng:", "x-ng-"], ge = /[A-Z]/g, Ac = !1, Rb, Oa = 3, ke = {
        full: "1.4.10",
        major: 1,
        minor: 4,
        dot: 10,
    ...
    var Hf = /([\:\-\_]+(.))/g, If = /^moz([A-Z])/, wb = {
        ...
        }, Ub = L("jqLite"), Lf = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/,
        Tb = /<|&#?\w+;/, Jf = /<([\w:-]+)/, Kf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ka = {
    ...
    p({
        data: Wb, removeData: ub, hasData: function (a) {
    ...
    p({
        data: Wb, inheritedData: Ab, scope: function (a) {
            ...
            var c = a.nodeType;
            if (c !== Oa && 2 !== c && 8 !== c)if (c = F(b), Bb[c])if (x(d))d ? (a[b] = !0, a.setAttribute(b, c)) : (a[b] = !1, a.removeAttribute(c)); else return a[b] || (a.attributes.getNamedItem(b) || y).specified ? c : v; else if (x(d))a.setAttribute(b, d); else if (a.getAttribute)return a = a.getAttribute(b, 2), null === a ? v : a
        }, prop: function (a, b, d) {
    ...
    p({
        removeData: ub, on: function (a, b, d, c) {
            ...
            if (g = (g = g && g.events) && g[f])c = {
                ...
                }, stopPropagation: y, type: f, target: a
            }, b.type && (c = M(c, b)), b = ha(g), e = d ? [c].concat(d) : [c], p(b, function (b) {
    ...
    var Qd = L("$animate"), Ye = function () {
        ...
        this.$get = ["$$AnimateRunner", "$rootScope", function (d, c) {
            ...
            return {
                enabled: y, on: y, off: y, pin: y, push: function (g, h, k, m) {
                    m && m();
                    k = k || {};
                    k.from && g.css(k.from);
                    k.to && g.css(k.to);
    ...
    }, bd = "application/json", ac = {"Content-Type": bd + ";charset=utf-8"}, Zf = /^\[|^\{(?!\{)/, $f = {
        "[": /]$/,
        "{": /}$/
    ...
    var zg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, bg = {http: 80, https: 443, ftp: 21}, Cb = L("$location"), Ag = {
        ...
        path: kd("$$path", function (a) {
            ...
            switch (arguments.length) {
                case 0:
                    return this.$$search;
                case 1:
                    if (H(a) || O(a))a = a.toString(), this.$$search = xc(a); else if (I(a))a = Na(a, {}), p(a, function (b, c) {
                        null == b && delete a[c]
    ...
    fc.prototype = {
        constructor: fc, lex: function (a) {
            ...
            for (var a = "", b = this.index; this.index < this.text.length;) {
                ...
                if ("." == d || this.isNumber(d))a += d; else {
                    ...
                    if ("e" == d && this.isExpOperator(c))a += d; else if (this.isExpOperator(d) &&
                        c && this.isNumber(c) && "e" == a.charAt(a.length - 1))a += d; else if (!this.isExpOperator(d) || c && this.isNumber(c) || "e" != a.charAt(a.length - 1))break; else this.throwError("Invalid exponent")
                }
                this.index++
            }
            ...
            for (var d = "", c = a, e = !1; this.index < this.text.length;) {
                ...
                if (e)"u" === f ? (e = this.text.substring(this.index + 1, this.index + 5), e.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + e + "]"), this.index += 4, d += String.fromCharCode(parseInt(e, 16))) : d += Bg[f] || f, e = !1; else if ("\\" === f)e = !0; else {
                    if (f === a) {
                        this.index++;
    ...
    s.prototype = {
        ...
        ternary: function () {
            ...
            return this.expect("?") && (b = this.expression(), this.consume(":")) ? (d = this.expression(), {
                type: s.ConditionalExpression, test: a, alternate: b,
                consequent: d
            }) : a
        },
        logicalOR: function () {
        ...
        constants: {
            ...
            undefined: {type: s.Literal, value: v},
    ...
    sd.prototype = {
        ...
        generateFunction: function (a, b) {
            ...
            if (!f && x(a.watchId))b = b || this.nextId(), this.if_("i",
                this.lazyAssign(b, this.computedMember("i", a.watchId)), this.lazyRecurse(a, b, d, c, e, !0)); else switch (a.type) {
                case s.Program:
                    ...
                    k.recurse(a.object, g, v, function () {
                        k.if_(k.notNull(g), function () {
                            ...
                            if (a.computed)h = k.nextId(), k.recurse(a.property, h), k.getStringValue(h), k.addEnsureSafeMemberName(h), e && 1 !== e && k.if_(k.not(k.computedMember(g, h)), k.lazyAssign(k.computedMember(g, h), "{}")), l = k.ensureSafeObject(k.computedMember(g,
                                h)), k.assign(b, l), d && (d.computed = !0, d.name = h); else {
                                Wa(a.property.name);
    ...
    var gg = Object.prototype.valueOf, ya = L("$sce"), la = {
            HTML: "html",
            CSS: "css",
            URL: "url",
    ...
    var Ib = {
        $addControl: y, $$renameControl: function (a, b) {
            a.$name = b
    ...
    var Ce = ["$animate", function (a) {
            ...
            this.$$runValidators = function (a, b, c) {
                ...
                (function () {
                    ...
                    if (r(z))f(a, null); else return z || (p(q.$validators, function (a, b) {
                        f(b, null)
        ...
        Te = function () {
            ...
            terminal: !0,
            priority: 1E3
        }), Jg = L("ngOptions"), Kg = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,
        Ne = ["$compile", "$parse", function (a, b) {
            function d(a, c, d) {
                ...
                return {
                    trackBy: r, getTrackByValue: w, getWatchables: b(z, function (a) {
                        var b = [];
                        a = a || [];
                ...
                compile: function (e, f) {
                    ...
                    return function (a, e, f, k, m) {
                        ...
                        a.$watchCollection(l, function (f) {
                            ...
                            n && (a[n] = f);
                            if (za(f))H = f, l = q || w; else for (I in l = q || t, H = [], f)sa.call(f, I) && "$" !== I.charAt(0) && H.push(I);
                            G = H.length;
                            I = Array(G);
                            for (k = 0; k < G; k++)if (B = f === H ? k : H[k], C = f[B], E = l(B, C, k), r[E])F = r[E], delete r[E], z[E] = F, I[k] = F; else {
        ...
        pe = function () {
            return {
                restrict: "E", require: ["select", "?ngModel"], controller: Mg, priority: 1, link: {
