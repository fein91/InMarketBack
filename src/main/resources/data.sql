...
-- CREATE TABLE orderbook (id int, counterparty_fk int, price DECIMAL(18, 2), amount DECIMAL(18, 2), date DATE);
...
insert into order_book(id, counterparty_fk, price, amount, date, order_type)
values (111, 1, 25, 200, SYSDATE, 0);
insert into order_book(id, counterparty_fk, price, amount, date, order_type)
values (112, 3, 24, 50, SYSDATE, 0);
insert into order_book(id, counterparty_fk, price, amount, date, order_type)
values (113, 4, 23, 100, SYSDATE, 0);
